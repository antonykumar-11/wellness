...
//   // Calculate total debit and credit transactions for the specific ledger
//   const totalDebitTransactions =
//     transactions.reduce((total, transaction) => {
//       if (transaction.debitLedger === ledgerId) {
//         total += transaction.debitAmount || 0; // sum of all debit amounts
//       }
//       return total;
//     }, 0) + openingBalance; // Add opening balance as debit

//   const totalCreditTransactions = transactions.reduce((total, transaction) => {
//     if (transaction.creditLedger === ledgerId) {
//       total += transaction.creditAmount || 0; // sum of all credit amounts
//     }
//     return total;
//   }, 0);
...
//     totalTransactions: totalDebitTransactions + totalCreditTransactions, // Total of both
