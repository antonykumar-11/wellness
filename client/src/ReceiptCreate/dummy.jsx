...
const ReceiptPreview = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const payload = {
        transactionId: debitNote.transactionId, // Ensure transactionId is available
        updatedPurchase: {
          ...purchaseData, // Spread the current purchaseData

          voucherType: "Receipt Voucher", // Ensure correct voucher type
        },
      };
  ...
  const handleDeletePayment = async (e) => {
    ...
    try {
      ...
      if (deleteResult) {
        ...
        navigate("/reports/receiptreports");
  ...
  useEffect(() => {
    if (paymentVoucher) {
      ...
      setPurchaseData((prevData) => ({
        ...
        ...filteredVoucher,
        voucherNumber: voucher1 || "", // Ensure voucher1 is defined or provide a fallback
