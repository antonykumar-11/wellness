...
const ReceiptDetails = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await createPayment(voucherData);
      console.log("response", response);
      if (response?.data?.voucherType === "Receipt Voucher") {
        ...
        toast.error("Failed to create Reciept Voucher");
      }
    } catch (error) {
                ...
                <div className="bg-white lg:mr-24 rounded-lg p-6 md:p-8 max-w-lg md:max-w-6xl mx-auto relative shadow-lg border border-blue-300">
                  ...
                  <div className="overflow-y-auto max-h-[70vh]">
                    ...
                    <p className="text-sm mb-4 leading-relaxed tracking-wide">
                        ഈ ഭാഗത്തു നിങ്ങൾ കടമായി എന്തെങ്കിലും സേവനം
                      നൽകിയിട്ടുണ്ടെങ്കിൽ അതിനു അവരിൽ നിന്നും കിട്ടുന്ന പൈസ
                      മാത്രമേ രേഖപെടുത്താവു . ഉദാഹരണത്തിന് നമ്മൾ വാഹനം
                      വാടകയ്ക്കു കൊടുത്തത്തിന്റെ പൈസ കിട്ടുമ്പോൾ
                    </p>
                    <p className="text-sm mb-4 leading-relaxed tracking-wide">
                      <span className="font-bold mr-2">Debit Ledger:</span>
                      നമ്മൾ സേവനം നൽകിയപ്പോൾ ആരെ ആണ് Credit Ledger ഭാഗത്തു
                      Sundry Debtor ആയിട്ടു വച്ചതു അവരെ ഇവിടെ Debit Ledger
                      ഭാഗത്തു വയ്ക്കുക
                    </p>
                    <p className="text-sm mb-4 leading-relaxed tracking-wide">
                      <span className="font-bold mr-2">Credit Ledger:</span>
                      നമ്മൾ നൽകിയ സേവനത്തിനു പൈസ ( Cash ) അല്ലെങ്കിൽ ബാങ്കിൽ (
                      Bank Accounts ) പൈസ കിട്ടും അതിനെ Credit Ledger ഭാഗത്തു
                      വയ്ക്കുക
                    </p>
                    <p className="text-sm mb-4 leading-relaxed tracking-wide m-4">
                      <span className="font-bold mr-2">Description :</span>ഈ
                      transaction നടന്നതിന്റെ കാരണം നമുക്ക് മനസ്സിലാക്കാൻ
                    </p>
                  </div>
                </div>
              </div>
